...
export const ENGINEERING_SNAPSHOT: EngineeringSnapshot = {
  ...
  last_evidence: "suíte de verificações 2026-08-20T17:54:00Z",
...
export const HEALTH_FIXTURES: ServiceHealth[] = [
  {
    ...
    checks: [{ name: "ready", status: "unknown", detail: "falha na sonda" }],
    http: { status: "unknown", detail: "falha na sonda" },
    tls: { status: "unknown" },
  ...
  },
  {
    ...
    latency_ms: 820,
    checks: [{ name: "ready", status: "degraded", detail: "observação mais velha que a janela" }],
  },
  {
    schema_version: "control-center.service-health.v1",
...
export const DIRECTIVE_FIXTURES: Directive[] = [
  ...
  },
  {
    ...
    body: "Atualização defasada no recorte Asaas. Confiança e recência são eixos distintos.",
...
export const AGENT_ACTIVITY_FIXTURES: AgentActivity[] = [
  {
    ...
    summary: "Observação defasada: continua em execução. Não promover a concluído.",
    provenance: provenance(
      "collector",
      "report",
    ...
    evidence_refs: [],
    residual_work: ["confirmar evidência de liquidação"],
    blockers: ["recorte financeiro defasado"],
  },
  {
    schema_version: "control-center.agent-activity.v1",
    ...
    goal: "Preparar briefing financeiro de recebíveis vencidos.",
    summary: "Recorte financeiro lido; falta confirmar a evidência de liquidação.",
    provenance: provenance(
      "collector",
      "report",
    ...
    residual_work: ["Confirmar evidência de liquidação de fatura vencida há mais de 30 dias"],
  },
  {
    schema_version: "control-center.agent-activity.v1",
    ...
    summary: "Status fora da lista prevista; apresentado como desconhecido.",
    provenance: provenance(
      "collector",
      "report",
