...
| Clients | derived from Warmbly ops | projector | inherits commercial | inherits | clients v1 | `/v1/domains/clients` | Clientes `#/clientes/<slug>` with Warmbly/Asaas/Governance cards | no | missing Asaas shown as UNKNOWN source | CREDENTIAL_GATE |
